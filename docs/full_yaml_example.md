...
This example matches the current `dx_ct511n` component structure and uses a local external component path.
...
wifi:
  ...
  ap:
    ssid: "Ct511N Fallback Hotspot"
    password: "wU3wbU53fFVD"
